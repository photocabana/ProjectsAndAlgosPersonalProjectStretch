    ...
    return (
        <div>
            ...
            <div className='card @media'>
                ...
                <p>
                Meet the visionary behind it all – Rindy, the driving force of this artistic haven. RHFDesignsOnline came to life during the summer of 2020, amidst the tumultuous backdrop of the pandemic. It was a time when the world yearned for a touch of beauty and a dash of hope.
                </p>
                <p>
                ...
                <p>
                Browse, explore, and join Rindy on this exhilarating adventure of artistic innovation. Your special creation awaits, and Rindy is eager to bring it to life. Contact her today to turn your vision into a stunning reality. 🎨💫🌷📷 #RHFDesignsOnline #ArtistryUnleashed
                </p>
                <p>🌟RHFDesignsOnline</p>
        </div>
        <div className='card @media'>
